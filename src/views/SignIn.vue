      ...
      <div class="row">
        <q-card square bordered class="q-pa-lg shadow-1">
          <q-card-section>
            ...
            <q-btn class="q-ma-sm full-width" :ripple="{ center: true }" color="primary" size="lg" label="Login" @click="login()"/>
          ...
          <q-card-section class="text-center q-pa-none">
            <q-btn flat size="sm" @click="goToRegisterPage()">Not reigistered? Created an Account</q-btn>
          </q-card-section>
        </q-card>
      </div>
    </div>
