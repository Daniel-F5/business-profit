<template>
<q-page class="full-height full-width column items-center justify-center">
  <div class="column q-mt-md" dir="rtl">
  ...
  <p class="text-subtitle1 q-mx-xl">אם אהבת את האתר או שסתם בא לך לדבר על קוד, אפשר ליצור איתי קשר כאן:</p>
  </div>
  <div class="row q-mb-xl">
    <a href="https://github.com/Daniel-F5"><img class="icon q-mx-md" src="../assets/GitHub-Mark-64px.png" width="32" height="32" alt="github"></a>
    <a href="mailto:daniel5xdx@gmail.com"><img class="icon q-mx-md" src="https://www.vectorlogo.zone/logos/gmail/gmail-icon.svg" width="32" height="32" alt="gmail"></a>
